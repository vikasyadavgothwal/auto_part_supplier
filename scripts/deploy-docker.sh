...
APP_NAME="${APP_NAME:-supplier_dashboard}"
CONTAINER_NAME="${CONTAINER_NAME:-supplier-dashboard}"
IMAGE_NAME="${IMAGE_NAME:-supplier-dashboard}"
...
HEALTH_PATH="${HEALTH_PATH:-/dashboard}"
