...
type BusinessPlan = {
  ...
  limits: { staff: number | null; roles: number | null; products: number | null; brands: number | null; categories: number | null }
...
type BusinessAccess = {
  businessAccount: { id: string; type?: string; plan: BusinessPlan; usage?: { staff?: number; products?: number; brands?: number; categories?: number } }
